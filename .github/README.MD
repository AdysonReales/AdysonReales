...
<table width="100%" style="background-color: #008080; border: 2px solid #ffffff;">
  <tr>
    <td style="background-color: #000080; color: #ffffff; font-weight: bold; padding: 4px 8px;">
      <img src="https://win98icons.alexmeub.com/icons/png/directory_program_group-0.png" width="16" align="center"> C:\System_Environment\Desktop_Icons.sys
    </td>
  </tr>
  <tr>
    <td>
